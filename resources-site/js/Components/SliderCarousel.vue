<template>
    <div
        v-if="parsedSliders.length"
        class="group relative w-full overflow-hidden bg-gray-900 h-[280px] sm:h-[380px] md:h-[480px] lg:h-[540px]"
        ...
        >
            ...
            >
                ...
                <div class="absolute inset-0 flex items-center justify-center p-6 text-center text-white md:p-12">
                    <div
                        class="mx-auto max-w-4xl transform transition-all duration-700 delay-100"
                    ...
                    >
                        ...
                        >
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1">
