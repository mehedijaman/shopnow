...
{
    public function index(SeoService $seoService, GetArchiveOptions $getArchiveOptions, GetTagOptions $getTagOptions, GetPostsFromArchive $getPostsFromArchive, string $archiveDate): View
    {
