    ...
    <div class="mx-auto max-w-7xl px-6 py-12 lg:px-6">
        <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
            <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                >
                    <li
                        class="after:border-1 text-primary-700 dark:text-primary-500 flex items-center after:mx-6 after:hidden after:h-1 after:w-full after:border-b after:border-gray-200 dark:after:border-gray-700 sm:after:inline-block sm:after:content-[''] md:w-full xl:after:mx-10"
                    >
                        <span
                    ...
                    <div class="min-w-0 flex-1 space-y-8">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <input
                                                type="text"
                                                id="phone-input"
                                                class="focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 z-20 block w-full rounded-e-lg border border-s-0 border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:border-s-gray-700 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400"
                        ...
                        <div>
                            ...
                            <div class="flex max-w-md items-center gap-4">
                                ...
                                <button
                                    type="button"
                                    class="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 flex items-center justify-center rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:outline-none focus:ring-4"
                                >
                                    Apply
                                </button>
                            </div>
