<template>
    <div class="mt-10">
        ...
        <small
            v-show="brandStore.showSeoAlert()"
        ...
        <template v-if="showSeoForm">
            <div>
                ...
                <div>
                    <p class="text-2xl text-skin-primary-11">
                        {{ brandStore.brand.meta_tag_title }}
                    </p>

                    <p class="">
                        {{ brandStore.brand.meta_tag_description }}
                    </p>
                </div>
            </div>
            ...
            <div class="mt-5 border-t border-dashed pt-5">
                ...
                <AppInputText
                    id="meta_tag_title"
                    v-model="brandStore.brand.meta_tag_title"
                    type="text"
                    maxlength="60"
                    :class="{
                ...
                <small class="block text-right text-skin-neutral-9">
                    {{ brandStore.getRemainingChars('meta_tag_title', 60) }}
                    of 60
                </small>
            </div>
            ...
            <div class="mt-5">
                ...
                <AppTextArea
                    ...
                    v-model="brandStore.brand.meta_tag_description"
                    class="h-24"
                    maxlength="160"
                    :class="{
...
const toggleSeoForm = () => {
    if (
        !showSeoForm.value &&
        isCreate.value &&
        !brandStore.brand.meta_tag_title.length &&
        !brandStore.brand.meta_tag_description.length
    ) {
        brandStore.initSeoTags()
    }
